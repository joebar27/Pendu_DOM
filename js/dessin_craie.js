...
function chalkboard(){
	$('#chalkboard').remove();
	$('.chalk').remove();
	$('main').prepend('<div class="panel"><a class="link" target="_blank">Save</a></div>');
	$('main').prepend('<img src="img/empty-blackboard-lite.jpg" id="pattern" width=50 height=50>');
	$('main').prepend('<canvas id="chalkboard"></canvas>');
	$('main').prepend('<div class="chalk"></div>');
	
	var canvas = document.getElementById("chalkboard");
	$('#chalkboard').css('width',$('main').width());
	$('#chalkboard').css('height',$('main').height());
